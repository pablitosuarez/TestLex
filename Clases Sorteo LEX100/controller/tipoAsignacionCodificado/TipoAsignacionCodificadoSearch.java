...
/**
 * Class for TipoAsignacionCodificado search filters.
 * 
 * Generated by Expand.
 *
 */
@Name("tipoAsignacionCodificadoSearch")
@BypassInterceptors
public class TipoAsignacionCodificadoSearch extends AbstractEntitySearch<TipoAsignacion>
{
	...
	private TipoAsignacionCodificadoSearch filter;

	public TipoAsignacionCodificadoSearch() {
		setDefaultOrder("codigo");
	}
   ...
   /**
	...
	public TipoAsignacionCodificadoSearch getFilter() {
		if (filter == null) {
			filter = new TipoAsignacionCodificadoSearch();
		}
		return filter;
	}
