...
/**
 * Class for TipoAsignacionCodificado Home objects.
 * 
 * Generated by Expand.
 *
 */
@Name("tipoAsignacionCodificadoHome")
public class TipoAsignacionCodificadoHome extends AbstractEntityHome<TipoAsignacion>
{
    @In(create=true)
...
// Operation event callbacks
	...
	public void beforeAdd(TipoAsignacion tipoAsignacion) throws EntityOperationException {
		boolean error = false;
		if (tipoAsignacionCodificadoSearch.findByUuid(tipoAsignacion.getUuid()) != null){
			error = true;
